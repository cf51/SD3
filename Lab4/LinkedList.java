public class LinkedList {
	...
	public int size(){
		...
		for(Node n = headNode; n != null; n = n.nextNode) { //iterating through the nodes of the list 
			count++; 										//adding 1 to count each time it finds a node 
		}
	...
	public int total(){ 
		...
		for(Node n = headNode; n != null; n = n.nextNode) {			//adding the values of the nodes 
			sum += headNode.value;
			headNode = n.nextNode; 
			
		}
		
		return sum; //returning the sum of the nodes 
	}
